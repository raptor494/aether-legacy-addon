...
public class SkyrootBedRenderer extends TileEntitySpecialRenderer<TileEntitySkyrootBed> {
	...
	static {
		...
		for (EnumDyeColor enumdyecolor : aenumdyecolor) {
			TEXTURES[enumdyecolor.getMetadata()] = Aether
					.locate("textures/tile_entities/bed/"
							+ enumdyecolor.getDyeColorName() + ".png");
		}
	}
}
