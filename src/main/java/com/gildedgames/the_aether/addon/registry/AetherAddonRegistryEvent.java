...
public class AetherAddonRegistryEvent {
	 ...
	 * from {@link com.gildedgames.the_aether.blocks.portal.BlockAetherPortal}
	 * to {@link com.gildedgames.the_aether.addon.blocks.BlockAetherPortal}.
	 */
	...
	public void onPreRegisterBlockEvent(RegistryEvent.Register<Block> event) {
		...
		if (blockList[27] instanceof com.gildedgames.the_aether.blocks.portal.BlockAetherPortal) {
			...
			for (int i = 0; i < blockList.length; i++) {
				if (blockList[i] instanceof com.gildedgames.the_aether.blocks.portal.BlockAetherPortal) {
					index = i;
					break;
				}
			}
		...
		Block newPortalBlock = new com.gildedgames.the_aether.addon.blocks.BlockAetherPortal()
